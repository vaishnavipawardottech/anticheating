...
import {
    ListChecks, Zap, ChevronRight, Calendar, Tag, FileSearch,
...
const MCQPapers = () => {
    ...
    const fetchPapers = useCallback((filter) => {
        ...
        fetch(url)
            ...
            .then(data => {
                // Filter only MCQ papers
                const mcqPapers = Array.isArray(data) ? data.filter(p => p.paper_type === 'mcq') : [];
                setPapers(mcqPapers);
                setLoading(false);
            })
            .catch(err => {
        ...
        <div className="ap-container">
            ...
            <div className="ap-header">
                <div className="ap-title-group">
                    <ListChecks size={22} className="ap-title-icon" />
                    <div>
                        <h1 className="ap-title">MCQ Question Papers</h1>
                        <p className="ap-subtitle">Multiple choice question papers</p>
                    </div>
                </div>
                <button className="ap-generate-btn" onClick={() => navigate('/generate-mcq')}>
                    <Zap size={16} /> Generate MCQ Paper
                </button>
            </div>
            ...
            {loading ? (
                ...
                <div className="ap-empty">
                    ...
                    <h2>No MCQ papers yet</h2>
                    <p>Generate your first MCQ question paper to get started.</p>
                    <button className="ap-generate-btn" onClick={() => navigate('/generate-mcq')}>
                        <Zap size={16} /> Generate MCQ Paper
                    </button>
                </div>
                                ...
                                <div className="ap-card-left" onClick={() => navigate(`/papers/${id}`)}>
                                    ...
                                    <div className="ap-card-info">
                                        <div className="ap-card-meta">
                                            ...
                                            <span className="ap-badge type-badge mcq">MCQ</span>
